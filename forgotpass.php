...
<body>
  ...
  <section id = "main">
	<div class = "wrapper">
		<h2 id = "title1"> Forgot Password </h2>
		<p id = "description"> Enter your email to recover </p>
		<form id = "input-form">
			<div>
				<h4 class = "title-input">Email</h4>
            	<input type="text" name="username" placeholder="Enter your email" class="custom-input">
			</div>
